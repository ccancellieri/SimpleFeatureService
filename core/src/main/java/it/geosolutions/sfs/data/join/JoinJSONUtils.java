...
public class JoinJSONUtils {
    ...
    protected static JSONObject fetchRESTObject(String uri) throws MalformedURIException {
        ...
        try {
            ...
            return (JSONObject) JSONSerializer.toJSON(IOUtils.toString(connection.getInputStream(),
    ...
    /*
     * 
     * { result: { list: { items: [ { area: "Armenia", year: "2001", area_harvested_wheat: 108380, area_harvested_rice: null, area_harvested_maize:
     * 2602, area_harvested_flag_wheat: "  ", area_harvested_flag_rice: null, area_harvested_flag_maize: "  ", yield_wheat: 22659.07, yield_rice:
     * null, yield_maize: 37913.14, yield_flag_wheat: "Fc", yield_flag_rice: null, yield_flag_maize: "Fc", production_quantity_wheat: 245579,
     * production_quantity_rice: null, production_quantity_maize: 9865, production_quantity_flag_wheat: "  ", production_quantity_flag_rice: null,
     * production_quantity_flag_maize: "  " },
     */
    protected static Map<String, Map<String, String>> loadSource(JSONObject source,
            final String dw_pk) {
...
//                Collection<String> attr = null;
                while (iterator.hasNext()) {
                    ...
                    GeometryDescriptor defaultGeomType = schema.getGeometryDescriptor();

                    if (crs == null && defaultGeomType != null)
                        crs = defaultGeomType.getCoordinateReferenceSystem();

                    jsonWriter.key("geometry");
                    Geometry aGeom = (Geometry) feature.getAttribute(defaultGeomType.getLocalName());
                    if (aGeom == null) {
...
//                            continue;
                    ...
                    for (int j = 0; j < types.size(); j++) {
                        ...
                        if (value == null) {
                            ...
                            if (ad.equals(defaultGeomType)) {
                                ...
                                jsonWriter.key(name);
                                // ///////////////////////////////////////////////////////////////////////////////////// TODO
                                Geometry geom = DouglasPeuckerSimplifier.simplify((Geometry) value,
                                        0.1);
                                jsonWriter.writeGeom(geom != null && !geom.isEmpty() ? geom
                                        : (Geometry) value);
                            }
                        } else {
                            jsonWriter.key(name);
            ...
            if (hasGeom && featureBounding) {
                ...
                if (e == null) {
                    throw new Exception("Unable to get Envelope for featurecollection"); // TODO
                                                                                         // throw
                                                                                         // a
                                                                                         // more
                                                                                         // specific
        ...
        try {
            ...
            try {
                ...
                while (iterator.hasNext()) {
                    ...
                    if (aGeom != null) {
                        // ///////////////////////////////////////////////////////////////////////////////////// TODO
                        Geometry geom = DouglasPeuckerSimplifier.simplify(aGeom, 0.001);
                        jsonWriter.writeGeom(geom != null && !geom.isEmpty() ? geom : aGeom);
                        hasGeom = true;
                    } else {
                        jsonWriter.value(null);
                        ...
                        if (value != null) {
                            ...
                            if (value instanceof Geometry) {
                                ...
                                if (ad.equals(defaultGeomType)) {
                                    ...
                                    // ///////////////////////////////////////////////////////////////////////////////////// TODO
                                    Geometry geom = DouglasPeuckerSimplifier.simplify(
                                            (Geometry) value, 0.001);
                                    jsonWriter.writeGeom(geom != null && !geom.isEmpty() ? geom
                                            : (Geometry) value);
                                    //
                                }
            ...
            if (hasGeom && featureBounding) {
                ...
                if (e == null) {
                    throw new Exception("Unable to get Envelope for featurecollection"); // TODO // exception
                } else {
                    jsonWriter.writeBoundingBox(e);
                }
            }
